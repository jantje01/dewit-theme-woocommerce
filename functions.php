<?php
/**
 * Dewit Theme functions and definitions.
 *
 * @package DewitTheme
 */
...
define( 'DEWIT_THEME_VERSION', '0.1.0' );
...
if ( ! function_exists( 'dewit_theme_setup' ) ) {
	...
	function dewit_theme_setup(): void {
		load_theme_textdomain( 'dewit-theme', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'dewit-theme' ),
			'footer'  => __( 'Footer Menu', 'dewit-theme' ),
		) );
	}
}
...
function dewit_theme_widgets_init(): void {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'dewit-theme' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here.', 'dewit-theme' ),
	...
	register_sidebar( array(
		'name'          => __( 'Shop Sidebar', 'dewit-theme' ),
		'id'            => 'shop-sidebar',
		'description'   => __( 'Filters and widgets for WooCommerce shop pages.', 'dewit-theme' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
